...
recordedAtLocale = plz_cl.recordedAtLocale
hasDailyMaximum = plz_cl.hasDailyMaximum
hasDailyMinimum = plz_cl.hasDailyMinimum
isRecordedAtDateTime = plz_cl.isRecordedAtDateTime
...
hasAdjective = plz_cl_nar.hasAdjective
hasTemporalExpression = plz_cl_nar.hasTemporalExpression
